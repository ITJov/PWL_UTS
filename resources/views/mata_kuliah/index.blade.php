                    ...
                    @foreach($mks as $mk)
                        <tr>
                            ...
                            <td>
                                ...
                                <a id="deleteData" href="{{ route('mk-delete', ['mataKuliah' =>$mk->id]) }}" title="Delete"><button class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true">Delete</i></button></a>
                            </td>
                            {{--                            @endif--}}
                        </tr>
                    @endforeach
