...
{{--                            @if(Auth::user()->namaRole->nama_role=='Admin')--}}
                            <td>
                                ...
                                <a id="deleteData" href="{{ route('kurikulum-delete', ['kurikulum' =>$kurikulum->id]) }}" title="Delete"><button class="btn btn-danger btn-sm"><i class="fa fa-trash" aria-hidden="true">Delete</i></button></a>
                            </td>
{{--                            @endif--}}
                        </tr>
                    @endforeach
